...
def create_scatter_plot(x, y, xlabel='', ylabel='', point_labels=[]):
    '''
    Creates a scatter plot
    
    Inputs:
        x (Series): values to be plotted on the x axis
        y (Series): values to be plotted on the y axis
        xlabel, ylabel (str): labels for x-axix and y-axis
        point_labels (Series): lzbels for individual scatter points
